    <!--start mini sidebar-->
    <nav class="mini-sidebar d-flex flex-column" data-bs-scroll="true" id="mainSideNav" >
        <div class="border-bottom nav-header h-70 flex-shrink-0 ">
            <img src="assets/images/logo1.png" width="160" alt="">
            <button class="primary-menu-close  btn" type="button">
                <i class="material-icons-outlined">close</i>
            </butt>
        </div>
        <div class="sidebar-nav overflow-y-scroll p-3">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="component-navs-tabs.html"><i
                                    class="material-icons-outlined">arrow_right</i>Navs &
                                Tabs</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="form-input-group.html"><i
                                    class="material-icons-outlined">arrow_right</i>Input
                                Groups</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="table-basic-table.html"><i
                                    class="material-icons-outlined">arrow_right</i>Basic
                                Table</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="map-google-maps.html"><i
                                    class="material-icons-outlined">arrow_right</i>Google
                                Maps</a>
                        </li>
                        <li><a href="map-vector-maps.html"><i
                                    class="material-icons-outlined">arrow_right</i>Vector
                                Maps</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="p-3 border-top h-70 flex-shrink-0 d-flex align-items-center" id="dark-mode-switcher">
